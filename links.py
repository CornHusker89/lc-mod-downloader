...
# replace any "*" in the path with the path to the Lethal Company directory (copy path to plugins folder, EX: C:\Program Files (x86)\Steam\steamapps\common\Lethal Company/Bepinex/plugins)
